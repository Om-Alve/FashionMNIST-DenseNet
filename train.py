...
from utils import train_transforms,calculate_accuracy_and_loss,test_transforms,save_best_model
from config import *
...
if __name__ == '__main__':
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(opt,T_max=NUM_EPOCHS * len(train_dataloader),eta_min=1e-4)
