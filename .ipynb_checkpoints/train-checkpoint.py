...
if __name__ == '__main__':
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer=opt,T_max=NUM_EPOCHS * len(train_dataloader),eta_min=5e-5)
    acc = 0
    writer = SummaryWriter("runs/fashion_MNIST_v6.0")
